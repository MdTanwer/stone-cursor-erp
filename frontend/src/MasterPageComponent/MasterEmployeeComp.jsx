...
export default function MasterEmployeeComp({ openSiteIncharge, getMaxEmpId, setOpenSiteIncharge }) {
    const columns = [
    ...
    }, [open, updateOpen, openSiteIncharge]);
