...
const PaymentAmount = () => {
  ...
  const [dueAdvAmount, setDueAdvAmount] = useState("");
  const [mongodbId, setMongodbId] = useState();
  const [paymentReciptDelete, setPaymentReciptDelete] = useState("");
  ...
  const columns = [
    ...
    { title: "SuplierName", field: "suplierName" },
  ...
  const GetPayment = async () => {
    try {
      const response = await axios.get("payment/get/payment");
      debugger;
  ...
  const handleUpdateSubmit = async (event) => {
    debugger;
    event.preventDefault();
    const endpoint = `/payment/update/payment/${mongodbId}`;
  ...
  const onClickDelete = async (rowData) => {
    axios
      .delete(`/payment/delete/payment/${rowData._id}`)
      .then((res) => {
        debugger;
        console.log(res);
  ...
  const actions = [
    ...
    },
    {
      ...
      onClick: (event, rowData) => {
        ...
        setSuplierName(rowData.suplierName);
    ...
    },
    {
      ...
      onClick: (event, rowData) => {
        ...
        setPaymentReciptDelete(rowData.suplierName);
      },
    },
  ];
  return (
